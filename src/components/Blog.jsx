  ...
  return (
    <div className='mb-16'>
        <div className="bgblur relative">
          ...
          <div className="flex -mt-36 ml-36 items-center gap-x-16">
            <div ref={scrollContainer} className="blog-items flex overflow-x-scroll gap-x-4 w-[75%]" style={{scrollbarWidth: 'none'}}>
